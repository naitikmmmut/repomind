...
function IngestView({ onIngestStart, jobStatus, onBack, onToggleSidebar, HamburgerIcon }) {
    ...
    <main className="main-content" data-testid="ingest-view">
      <div className="border-b border-border p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <button className="md:hidden text-slate-400" onClick={onToggleSidebar} aria-label="Toggle sidebar">
            <HamburgerIcon />
          </button>
          <div>
      ...
      <div className="p-6 max-w-3xl">
        <div className="mb-4">
          <label htmlFor="repo-url" className="overline block mb-2">Repository URL</label>
          <input
            id="repo-url"
        ...
        <div className="mb-6">
          <label htmlFor="collection-name" className="overline block mb-2">Collection Name (optional)</label>
          <input
            id="collection-name"
